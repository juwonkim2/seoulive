...
public class CoursePageDTO {
	...
	public CoursePageDTO(CoursePageTO page, int totalAmount) {
		this.page = page;
		...
		int pagesPerPage = page.getPagesPerPage();
